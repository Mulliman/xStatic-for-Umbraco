    ...
    public class UmbTreeClientApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                opt.OperationFilter<UmbTreeClientOperationSecurityFilter>();
            });
        }

        public class UmbTreeClientOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
