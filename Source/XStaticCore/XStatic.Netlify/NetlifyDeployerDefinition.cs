...
namespace XStatic.Netlify
{
    ...
    public class NetlifyLegacyDeployerDefinition : IDeployerDefinition
    {
        public class FieldNames
        {
            public const string PAT = "NetlifyLegacy.PAT";
            public const string SiteId = "NetlifyLegacy.SiteId";
        }

        public string Id => NetlifyDeployerLegacy.DeployerKey;

        public string Name => "Netlify (Legacy)";
