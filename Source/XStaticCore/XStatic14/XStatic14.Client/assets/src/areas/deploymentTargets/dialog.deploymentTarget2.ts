...
// @customElement('xstatic-edit-deployment-target-modal2')
// export class EditDeploymentTarget2ModalElement extends
...
//                 propertyEditorUiAlias: "xstatic.propertyEditorUi.deploymentTargetForm2",
//                 config: [
//                     {
//                         alias: 'fields',
...
//         console.log("createPostModel _values", this._values);

//         var deployerFields = this._values.find((x) => x.alias === 'fields')?.value as DeployerField[];

//         console.log("createPostModel deployerFields", deployerFields);
...
//         console.log("arrayAsRecord", record);
...
// export const EditDeploymentTargetModal2 = new UmbModalToken<EditDeploymentTargetModalData, EditDeploymentTargetModalValue>(
//     "xstatic.deploymentTargetModal2",
//     {
//         modal: {
//             type: 'sidebar',
//             size: 'large',
...
// export default EditDeploymentTarget2ModalElement;