...
console.log('transformerFactories', this.config?.transformerFactories);
console.log('transformerFactories map', this.config?.transformerFactories?.map((x) => ({ name: x.name, value: x.id })) ?? []);
